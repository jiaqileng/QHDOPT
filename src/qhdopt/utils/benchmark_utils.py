...
def run_test(model, tol=1e-3):
    ...
    opt_samples, current_best, _, solver_time = model.classically_optimize(solver="IPOPT")
    ...
    opt_samples, current_best, _, solver_time = model.classically_optimize(solver="TNC")
